...
import { FulfillmentCreatedEvent } from './fulfillmentcreated.event';
import { FulfillmentUpdatedEvent } from './fulfillmentupdated.event';
import { FulfillmentDeletedEvent } from './fulfillmentdeleted.event';
import { FulfillmentStartedEvent } from './fulfillmentstarted.event';
import { PickTaskCreatedEvent } from './picktaskcreated.event';
import { PackCompletedEvent } from './packcompleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'fulfillment-created': createEventDefinition('fulfillment-created', FulfillmentCreatedEvent, EVENT_DEFINITION_OVERRIDES['fulfillment-created']),
  'fulfillment-updated': createEventDefinition('fulfillment-updated', FulfillmentUpdatedEvent, EVENT_DEFINITION_OVERRIDES['fulfillment-updated']),
  'fulfillment-deleted': createEventDefinition('fulfillment-deleted', FulfillmentDeletedEvent, EVENT_DEFINITION_OVERRIDES['fulfillment-deleted']),
  'fulfillment-started': createEventDefinition('fulfillment-started', FulfillmentStartedEvent, EVENT_DEFINITION_OVERRIDES['fulfillment-started']),
  'pick-task-created': createEventDefinition('pick-task-created', PickTaskCreatedEvent, EVENT_DEFINITION_OVERRIDES['pick-task-created']),
  'pack-completed': createEventDefinition('pack-completed', PackCompletedEvent, EVENT_DEFINITION_OVERRIDES['pack-completed']),
