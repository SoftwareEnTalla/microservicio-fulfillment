...
async function bootstrap() {
  ...
  try {
    ...
    logger.info(`ℹCreando instancia del módulo FulfillmentAppModule...`);
    const app = await NestFactory.create(FulfillmentAppModule, {
    ...
    const swaggerPath = setupSwagger(
      ...
      "API completa para gestión de Fulfillments con documentación automática",
      "1.0"
    );
