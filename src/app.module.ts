...
import { FulfillmentCommandController } from "./modules/fulfillment/controllers/fulfillmentcommand.controller";
import { FulfillmentModule } from "./modules/fulfillment/modules/fulfillment.module";
import { CqrsModule } from "@nestjs/cqrs";
import { AppDataSource, initializeDatabase } from "./data-source";
import { FulfillmentQueryController } from "./modules/fulfillment/controllers/fulfillmentquery.controller";
import { GraphQLModule } from "@nestjs/graphql";
import { ApolloDriver, ApolloDriverConfig } from "@nestjs/apollo";
import GraphQLJSON from "graphql-type-json";
import { FulfillmentCommandService } from "./modules/fulfillment/services/fulfillmentcommand.service";
import { FulfillmentQueryService } from "./modules/fulfillment/services/fulfillmentquery.service";
import { CacheModule } from "@nestjs/cache-manager";
import { LoggingModule } from "./modules/fulfillment/modules/logger.module";
...
@Module({
  imports: [
    ...
    /**
     * Módulos Fulfillment de la aplicación
     */
    CqrsModule,
    HorizontalModule,
    FulfillmentModule,
  ...
  /**
   * Controladores de Fulfillment
   *
   * Registro de controladores a nivel de aplicación.
   */
  controllers: [
  //No se recomienda habilitar los controladores si ya fueron declarados en el módulo: FulfillmentModule
  /*
  
  FulfillmentCommandController, 
  FulfillmentQueryController
  
  */
  ],

  /**
   * Proveedores (Servicios, Repositorios, etc.) de Fulfillment
   *
   ...
   */
  exports: [FulfillmentCommandService, FulfillmentQueryService,LoggerService],
})
export class FulfillmentAppModule implements OnModuleInit {
  /**
